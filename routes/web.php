...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('panel')->group(function () {
        ...
        Route::get('bidding/dispesas-inexigibilidade/create', [BiddingController::class, 'dispensaCreate'])->name('dispensa.create');
        Route::get('bidding/dispesas-inexigibilidade', [BiddingController::class, 'indexDispensa'])->name('dispensa.index');
        ...
        Route::post('/official-diary/upload/publications', [SecretaryPublicationController::class, 'store'])->name('testes.swas')->middleware('can:secretary-access');
