...
<h3 class="title-sub-page main">{{ $page_decree->title }}</h3>
<p class="description-text main mb-30">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
@endsection
...
<section class="section-decrees adjust-min-height no-padding-top">
    <div class="container">
            ...
            <div class="col-12">
                <div class="card main-card container-search-advanced">
                    <div class="search-advanced mb-0">
                        ...
                        <form action="{{ route('decretos.show') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
        ...
        @include('partials.cardByDecreeOrLaw', ['data' => $decrees, 'type' => 'Decreto'])

    </div>
</section>

@include('pages.partials.satisfactionSurvey', ['page_name' => 'Decretos'])
