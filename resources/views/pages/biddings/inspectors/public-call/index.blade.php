...
<h3 class="title-sub-page main">Chamamento publíco</h3>
@endsection
            ...
            <div class="col-12">
                <div class="card main-card container-search-advanced">
                    <div class="search-advanced mb-0">
                        ...
                        <form action="{{ route('dispensa.inexigibilidade') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-2">
                                ...
                                <div class="mt-2 col-md-12">
                                    <div class="h-100 form-group mb-0">
                                        <div class="btn-groups">
                                            ...
                                            <a href="{{ route('dispensa.inexigibilidade') }}" class="btn btn-search close btn-sm" data-toggle="tooltip" title="Limpar pesquisa"><i class="fa-solid fa-xmark"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
