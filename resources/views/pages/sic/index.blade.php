            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="description">{{ $sic->manager }}</p>
                    </div>
                    <div class="col-md-6">
                        <p class="title">Telefone</p>
                        <p class="description">{{ $sic->phone }}</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="description">{{ $sic->email }}</p>
                    </div>
                    <div class="col-md-6">
                        <p class="title">CEP</p>
                        <p class="description">{{ $sic->cep }}</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="description">{{ $sic->street }} nº{{ $sic->number }} - {{ $sic->neighborhood }} {{ $sic->complement }}</p>
                    </div>
                    <div class="col-md-6">
                        <p class="title">Horário de atendimento</p>
                        <p class="description">{{ $sic->opening_hours }}</p>
                    </div>
                </div>
