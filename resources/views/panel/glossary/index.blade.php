...
<div class="card">
    <div class="card-body">
        ...
        <div class="card-header text-right header-with-search">
            <a href="{{ route('glossary.create') }}" class="btn-default">Novo</a>
        ...
        @if($glossarys && $glossarys->count() > 0)
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions text-center">
                            <a href="{{ route('glossary.edit', $glossary->slug) }}" class="link edit"><i class="fas fa-edit"></i></a>
                        
                            <a data-toggle="modal" data-target="#myModal-{{ $glossary->id}}" class="link delete"><i class="fas fa-trash-alt"></i></a>
                        
                            <div id="myModal-{{$glossary->id}}" class="modal fade modal-warning" role="dialog">
                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form id="delete-form-{{ $glossary->id }}" action="{{ route('glossary.destroy', $glossary->slug) }}" method="post" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
