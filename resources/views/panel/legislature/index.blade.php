...
<div class="card">
    <div class="card-body">
        ...
        @if($legislatures && $legislatures->count() > 0)
                        ...
                        <td class="actions text-center">
                            <div class="btn-group dropleft">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="#">Vereadores</a>
                                    <a class="dropdown-item" href="{{ route('legislatures.edit', $legislature->slug) }}">Editar</a>
                                    <a class="dropdown-item" data-toggle="modal" data-target="#myModal-{{ $legislature->id }}" href="#">Excluir</a>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form id="delete-form-{{ $legislature->id }}" action="{{ route('legislatures.destroy', $legislature->slug) }}" method="post" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
