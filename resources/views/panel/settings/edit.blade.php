        ...
        <form action="{{ route('settings.update', $settings->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="plenary" class="form-control" value="{{ old('plenary', $settings->plenary) }}" />
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" class="form-control mask-phone" value="{{ old('phone', $settings->phone) }}" />
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="opening_hours" class="form-control" value="{{ old('opening_hours', $settings->opening_hours) }}" />
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="custom-input-file">
                            ...
                            <div class="container-temp-file">
                                @if($logo_footer != '')
                                <img class="image" src="{{ asset('storage/'.$logo_footer->url) }}" />
                                <button class="btn-delete" onclick="removeFile(event, 'container-temp-file', '/panel/files/{{$logo_footer->id}}')">
                                    <svg viewBox="0 0 24 24" style="fill: white; width: 20px; height: 20px;">
                                        <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" style="stroke-width: 4px;"></path>
                                    </svg>
                                </button>
