...
<div class="card">
    <div class="card-body">
        ...
        <div class="card-header text-right header-with-search">
            <a href="{{ route('chambers-financials.create') }}" class="btn-default">Novo</a>
        ...
        @if($chambersFinancial && $chambersFinancial->count() > 0)
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    @foreach($chambersFinancial as $chamberFinancial)
                    <tr>
                        ...
                        <td class="actions text-center">
                            ...
                            <a data-toggle="modal" data-target="#myModal-{{ $chamberFinancial->id }}" class="link delete"><i class="fas fa-trash-alt"></i></a>
                        
                            <div id="myModal-{{ $chamberFinancial->id }}" class="modal fade modal-warning" role="dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="#" class="btn btn-default" onclick="event.preventDefault();
                                                document.getElementById('delete-form-{{ $chamberFinancial->id }}').submit();">
                                                Deletar
                                            </a>

                                            <form id="delete-form-{{ $chamberFinancial->id }}" action="{{ route('chambers-financials.destroy', $chamberFinancial->slug) }}" method="post" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
        ...
        @else
        <div class="no-data">
            <span>Ainda não existem balancetes cadastrados.</span>
        </div>
        @endif
