...
<div class="card">
    <div class="card-body">
        ...
        <div class="card-header text-right">
            <a href="{{ route('categories.create') }}" class="btn-default">Novo</a>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <span title="{{ $category->children->count() > 0 ? 'Não é possível excluir uma categoria que possui subcategorias' : 'Excluir Categoria'}}"><a data-toggle="modal" data-target="#myModal{{$category->id}}" class="link delete {{ $category->children->count() > 0 ? 'disabled-link' : ''}}"><i class="fas fa-trash-alt"></i></a></span>
        ...
        @else
        <div class="no-data">
            <span>Ainda não existem categorias cadastradas.</span>
        </div>
        @endif
