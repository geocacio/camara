@extends('panel.index')
@section('pageTitle', 'Página de Dados Abertos')

@section('breadcrumb')
<li><a href="{{ route('materials.index') }}">Dados Abertos</a></li>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('dados-abertos.page.update', $page->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-2">
