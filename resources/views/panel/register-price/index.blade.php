@extends('panel.index')
@section('pageTitle', 'Atas de registros de preços')
...
<div class="card">
    <div class="card-body">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $ata->id }}</td>
                        <td>{{ $ata->title }}</td>
                        <td>{{ $ata->signature_date }}</td>
                        <td class="actions">
                            <a href="{{ route('register-price.edit', $ata->slug) }}" class="link edit"><i class="fas fa-edit"></i></a>
                            <a data-toggle="modal" data-target="#myModal{{$ata->id}}" class="link delete"><i class="fas fa-trash-alt"></i></a>

                            <div id="myModal{{$ata->id}}" class="modal fade modal-warning" role="dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="#" class="btn btn-default" onclick="event.preventDefault();
                                                document.getElementById('delete-form-{{ $ata->id }}').submit();">
                                                Deletar
                                            </a>



                                            <form id="delete-form-{{ $ata->id }}" action="{{ route('register-price.destroy', $ata->slug) }}" method="post" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
        ...
        @else
        <div class="no-data">
            <span>Ainda não existem atas cadastradas.</span>
        </div>
        @endif
