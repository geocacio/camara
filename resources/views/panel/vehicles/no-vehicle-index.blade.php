...
<div class="card">
    <div class="card-body">
        ...
        <div class="card-header text-right">
            <a href="{{ route('no-vehicle.create') }}" class="btn-default">Novo</a>
        </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $info->periodo }}</td>
                        {{-- <td>{{ $info->roles[0]->name }}</td> --}}
                        <td class="actions">
                            {{-- <a href="{{ route('veiculos.edit', $info->slug) }}" class="link edit"><i class="fas fa-edit"></i></a> --}}
                            <a data-toggle="modal" data-target="#myModal{{$info->id}}" class="link delete"><i class="fas fa-trash-alt"></i></a>

                            <div id="myModal{{$info->id}}" class="modal fade modal-warning" role="dialog">
                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        {{-- <div class="modal-footer">
                                            ...
                                            <form id="delete-form-{{ $info->id }}" action="{{ route('veiculos.destroy', $info->slug) }}" method="post" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div> --}}
