...
<div class="card">
    <div class="card-body">
        ...
        <div class="card-header text-right header-with-search">
            <a href="{{ route('authors.create', $material->slug) }}" class="btn-default">Novo</a>
        
        </div>


        @if($material->authors && $material->authors->count() > 0)
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions text-center">
                            <a href="{{ route('authors.edit', ['material' => $material->slug,'author' => $author->id]) }}" class="link edit"><i class="fas fa-edit"></i></a>
                            <a data-toggle="modal" data-target="#myModal-{{$author->id}}" class="link delete"><i class="fas fa-trash-alt"></i></a>

                            <div id="myModal-{{$author->id}}" class="modal fade modal-warning" role="dialog">
                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form id="delete-form-{{$author->id}}" action="{{ route('authors.destroy', ['material' => $material->slug,'author' => $author->id]) }}" method="post" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
