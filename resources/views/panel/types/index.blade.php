...
<div class="card">
    <div class="card-body">
        ...
        <div class="card-header text-right">
            <a href="{{ route('subtypes.create', $type->slug) }}" class="btn-default">Novo</a>
        </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $type->name }}</td>
                        <td class="actions">
                            <a href="{{ route('types.edit', $type->slug) }}" class="link edit"><i class="fas fa-edit"></i></a>
                            <a data-toggle="modal" data-target="#myModal{{$type->id}}" class="link delete"><i class="fas fa-trash-alt"></i></a>

                            <div id="myModal{{$type->id}}" class="modal fade modal-warning" role="dialog">
                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form id="delete-form-{{ $type->id }}" action="{{ route('types.destroy', $type->slug) }}" method="post" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
        ...
        @else
        <div class="no-data">
            <span>Ainda não existem tipos cadastrados.</span>
        </div>
        @endif
