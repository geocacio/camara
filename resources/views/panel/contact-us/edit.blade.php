            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="telefone" class="form-control" autocomplete="off" value="{{ old('telefone', $contactUsPage->telefone) }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>HORÁRIO DE ATENDIMENTO</label>
                        <input type="text" name="opening_hours" class="form-control" autocomplete="off" value="{{ old('opening_hours', $contactUsPage->opening_hours) }}">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="d-flex align-items-center justify-content-center w-fit-content actions">
                    <div class="toggle-switch cmt-4">
                        <input type="checkbox" id="checklist" name="visibility" value="enabled" class="toggle-input" {{ $page->visibility == 'enabled' ? 'checked' : ''}}>
