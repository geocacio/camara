@extends('panel.index')
@section('pageTitle', 'Responsabilidades')

@section('breadcrumb')
<li><a href="{{ route('biddings.index') }}">Licitações</a></li>
<li><span>Responsabilidades</span></li>
@endsection
...
<div class="card">
    <div class="card-body">
        ...
        <div class="card-header text-right">
            <a href="{{ route('biddings.responsibilities.create', $bidding->slug) }}" class="btn-default">Novo</a>
        </div>

        @if($responsibilities && $responsibilities->count() > 0)
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions text-right">
                            <a href="{{ route('biddings.responsibilities.edit', ['responsibility' => $responsibility->slug, 'bidding' => $bidding->slug]) }}" class="link edit"><i class="fas fa-edit"></i></a>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form id="delete-form-{{ $responsibility->id }}" action="{{ route('biddings.responsibilities.destroy', ['responsibility' => $responsibility->slug, 'bidding' => $bidding->slug]) }}" method="post" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
        ...
        @else
        <div class="no-data">
            <span>Ainda não existem Responsabilidades cadastradas.</span>
        </div>
        @endif
