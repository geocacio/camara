@extends('panel.index')
@section('pageTitle', 'Forma de publicação')

@section('breadcrumb')
<li><a href="{{ route('biddings.index') }}">Licitações</a></li>
<li><span>Forma de publicação</span></li>
@endsection
...
<div class="card">
    <div class="card-body">
        ...
        <div class="card-header text-right">
            <a href="{{ route('biddings.publications.create', $bidding->slug) }}" class="btn-default">Novo</a>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions text-right">
                            <a href="{{ route('biddings.publications.edit', ['bidding' => $bidding->slug, 'publicationForm' => $publication->slug]) }}" class="link edit"><i class="fas fa-edit"></i></a>
        ...
        @else
        <div class="no-data">
            <span>Ainda não existem publications cadastrados.</span>
        </div>
        @endif
