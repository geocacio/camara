...
@section('pageTitle', 'Nova Dispensa ou Inexigibilidade')
@section('breadcrumb')
<li><a href="{{ route('biddings.index') }}">Dispensa e Inexigibilidade</a></li>
<li><span>Dispensa e Inexigibilidade</span></li>
@endsection
@section('content')
<div class="card">
    <div class="card-body">
            ...
            <div class="tab-pane fade show active" id="tabBidding" role="tabpanel" aria-labelledby="bidding-tab">
                <form id="biddingSubmit">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" value="dispensa" name="type_bidding">
