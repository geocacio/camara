...
@section('pageTitle', 'Editando Dicionário')
...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('dictionary.update', $dictionary->slug) }}" method="post">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Titulo</label>
                        <input type="text" name="title" class="form-control" value="{{ old('title', $dictionary->title) }}" />
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control">{{ old('description', $dictionary->description) }}</textarea>
                    </div>
                </div>
            </div>
