...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('symbols.update', $symbol->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        <label>Ícone</label>
                        <input type="text" name="icon" class="form-control icon" autocomplete="off" value="{{ old('icon', $pageSymbol->icon) }}" onfocus="getIconInputValues(event)">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="form-group">
                        <label>Título Principal</label>
                        <input type="text" name="main_title" class="form-control" autocomplete="off" value="{{ old('main_title', $pageSymbol->main_title) }}">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="form-group">
                        <label>Título</label>
                        <input type="text" name="title" class="form-control" autocomplete="off" value="{{ old('title', $pageSymbol->title) }}">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <label>Text</label>
                <input type="text" name="description" class="form-control" autocomplete="off" value="{{ old('description', $pageSymbol->description) }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="himn_url" class="form-control" value="{{ old('himn_url', $symbol->himn_url) }}" />
            </div>

            <div class="form-group">
                <label>Hino</label>
                <textarea name="himn" class="form-control">{{ old('himn', $symbol->himn) }}</textarea>
            </div>
                    ...
                    <div class="form-group">
                        <div class="custom-input-file">
                            ...
                            <div class="container-temp-file">
                                @if($coatArms != '')
                                <img class="image" src="{{ asset('storage/'.$coatArms->url) }}" />
                                <button class="btn-delete" onclick="removeFile(event, 'container-temp-file', '/panel/files/{{$coatArms->id}}')">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="custom-input-file">
                            ...
                            <div class="container-temp-file">
                                @if($flag != '')
                                <img class="image" src="{{ asset('storage/'.$flag->url) }}" />
                                <button class="btn-delete" onclick="removeFile(event, 'container-temp-file', '/panel/files/{{$flag->id}}')">
                                    <svg viewBox="0 0 24 24" style="fill: white; width: 20px; height: 20px;">
                                        <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" style="stroke-width: 4px;"></path>
                                    </svg>
                                </button>
