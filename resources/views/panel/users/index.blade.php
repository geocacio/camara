...
<div class="card">
    <div class="card-body">
        ...
        <div class="card-header text-right">
            <a href="{{ route('users.create') }}" class="btn-default">Novo</a>
        </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <a href="{{ route('users.edit', $user->id) }}" class="link edit"><i class="fas fa-edit"></i></a>
                            <a data-toggle="modal" data-target="#myModal{{$user->id}}" class="link delete"><i class="fas fa-trash-alt"></i></a>

                            <div id="myModal{{$user->id}}" class="modal fade modal-warning" role="dialog">
