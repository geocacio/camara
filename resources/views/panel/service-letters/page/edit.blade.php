@extends('panel.index')
@section('pageTitle', 'Página Cartas de Serviços')

@section('breadcrumb')
<li><a href="{{ route('serviceLetter.index') }}">Cartas de Serviços</a></li>
<li><span>Atualizar Página</span></li>
@endsection
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('serviceLetter.page.update', $pageServiceLetter->id) }}" method="post">
            @csrf
            @method('PUT')
