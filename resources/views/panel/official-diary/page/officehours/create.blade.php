        ...
        <form action="{{ route('diary.expedient.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Site</label>
                        <input type="text" name="site" class="form-control" autocomplete="off" value="{{ old('site') }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>URL do diário</label>
                        <input type="text" name="url_diario" class="form-control" autocomplete="off" value="{{ old('url_diario') }}">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="expedient" class="form-control" autocomplete="off">{{ old('expedient') }}</textarea>
                    </div>
                </div>
            </div>
