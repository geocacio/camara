@extends('panel.index')
@section('pageTitle', 'Leis de Normativas')
...
<div class="card">
        ...
        <div class="card-header text-right header-with-search">
            <div class="btn-group dropleft">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ route('normative.laws') }}">Novo</a>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions text-center">
                            <a href="{{ route('normative.laws', $file->id) }}" class="link edit"><i class="fas fa-edit"></i></a>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form id="delete-form-{{ $file->id }}" action="{{ route('normative.laws.delete', $file->id) }}" method="post" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
    ...
    {{-- @include('panel.partials.footerCardWithPagination', ['routePerPage' => 'normative.index', 'paginate' => $files]) --}}
