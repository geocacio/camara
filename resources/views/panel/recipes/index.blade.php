        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $recipe->id }}</td>
                        <td>{{ date('d/m/Y', strtotime($recipe->recipe_data)) }}</td>
                        <td>{{ $recipe->exercise }}</td>
                        <td>{{ $recipe->organ }}</td>
                        <td>{{ $recipe->value }}</td>
                        <td class="actions text-center">
                            <a href="{{ route('recipes.edit', $recipe->id) }}" class="link edit"><i class="fas fa-edit"></i></a>
                        
                            <a data-toggle="modal" data-target="#myModal-{{ $recipe->id}}" class="link delete"><i class="fas fa-trash-alt"></i></a>
                        
                            <div id="myModal-{{$recipe->id}}" class="modal fade modal-warning" role="dialog">
