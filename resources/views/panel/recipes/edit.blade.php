                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="text_button" class="form-control" value="{{ old('text_button', $recipe->text_button) }}" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>URL</label>
                            <input type="link" name="url" class="form-control" value="{{ old('url', $recipe->url) }}" />
                        </div>
                    </div>
                </div>
            </div>
