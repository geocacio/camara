...
<div class="card">
    <div class="card-body">
        ...
        <div class="card-header text-right">
            {{--<a href="{{ route('constructions.contracts.create', $construction->slug) }}" class="btn-default">Novo</a>--}}
            ...
            <div class="btn-group dropleft">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ route('constructions.contracts.create', $construction->slug) }}">Novo</a>
        ...
        @if($construction->generalContracts && $construction->generalContracts->count() > 0)
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    @foreach($construction->generalContracts as $contracts)
                    <tr>
                        <td>{{ $contracts->id }}</td>
                        <td>{{ $contracts->number }}</td>
                        <td>{{ $contracts->types[0]->name }}</td>
                        <td class="actions text-center">
                            <a href="{{ route('constructions.contracts.edit', ['construction' => $construction->slug, 'contract' => $contracts->slug]) }}" class="link edit"><i class="fas fa-edit"></i></a>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form id="delete-form-{{ $contracts->id }}" action="{{ route('constructions.contracts.destroy', ['construction' => $construction->slug, 'contract' => $contracts->slug]) }}" method="post" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
