        ...
        <div class="card-header text-right">
            ...
            <div class="btn-group dropleft">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" data-toggle="modal" data-target="#modalNoData">Período sem Obras</a>
                </div>
            </div>
        
        </div>

        <x-modal-no-info modalId="modalNoData" modalTitle="Período sem Obras" formAction="{{ route('noInformationstore') }}">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $info->periodo }}</td>
                                    <td class="">
                                        <a href="{{ route('no-info.edit', [$info->id, 'obras']) }}" class="link edit"><i class="fas fa-edit"></i></a>
