...
<div class="card">
    <div class="card-body">
        ...
        <div class="card-header text-right">
            <a href="{{ route('constructions.file.create', $construction->slug) }}" class="btn-default">Novo</a>
        </div>


        @if($construction->files && $construction->files->count() > 0)
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions text-center">
                            <a href="{{ route('constructions.file.edit', ['construction' => $construction->slug, 'file' => $file->file->id]) }}" class="link edit"><i class="fas fa-edit"></i></a>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form id="delete-form-{{ $file->id }}" action="{{ route('constructions.file.destroy', ['construction' => $construction->slug, 'file' => $file->file->id]) }}" method="post" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
