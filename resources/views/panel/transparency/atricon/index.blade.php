                    ...
                    @foreach($pages as $index => $page)
                        <tr>
                            ...
                            <td class="actions text-center">
                                @if($page->favs_count > 0)
                                    <a href="#" title="Remover do atricon" class="link destaque" onclick="event.preventDefault();
                                        document.getElementById('destaque-{{ $page->id }}').submit();">
                                        <i class="fa-solid fa-star"></i>
                                    </a>
                                @else
                                    <a title="Adicionar ao atricon" href="#" class="link destaque" onclick="event.preventDefault();
                                        document.getElementById('destaque-{{ $page->id }}').submit();">
