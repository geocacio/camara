...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('lrfs.update', $lrf->slug) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="type" class="form-control">
                            ...
                            <option value="{{ $type->id}}" {{$type->id == $lrf->types[0]->id ? 'selected' : ''}}>{{ $type->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="competence" class="form-control">
                            ...
                            <option value="{{ $competency->id}}" {{ in_array($competency->name, array_column($lrfCategories->toArray(), 'name')) ? 'selected' : '' }}>{{ $competency->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="exercicy" class="form-control">
                            ...
                            <option value="{{ $exercicy->id}}" {{ in_array($exercicy->name, array_column($lrfCategories->toArray(), 'name')) ? 'selected' : '' }}>{{ $exercicy->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Data</label>
                        <input type="date" name="date" class="form-control" value="{{ old('date', $lrf->date) }}" />
                    </div>
                </div>
            </div>
