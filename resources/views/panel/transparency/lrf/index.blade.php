...
<div class="card">
    <div class="card-body">
        ...
        <div class="card-header text-right">
            <a href="{{ route('lrfs.create') }}" class="btn-default">Novo</a>
        </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <a href="{{ route('lrfs.edit', $lrf->slug) }}" class="link edit"><i class="fas fa-edit"></i></a>
                            <a data-toggle="modal" data-target="#myModal{{$lrf->id}}" class="link delete"><i class="fas fa-trash-alt"></i></a>

                            <div id="myModal{{$lrf->id}}" class="modal fade modal-warning" role="dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="#" class="btn btn-default" onclick="event.preventDefault();
                                                document.getElementById('delete-form-{{ $lrf->id }}').submit();">
                                                Deletar
                                            </a>



                                            <form id="delete-form-{{ $lrf->id }}" action="{{ route('lrfs.destroy', $lrf->slug) }}" method="post" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
        ...
        @else
        <div class="no-data">
            <span>Ainda não existem lrfs cadastrados.</span>
        </div>
        @endif
