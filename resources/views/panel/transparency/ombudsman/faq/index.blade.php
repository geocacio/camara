...
<div class="card">
    <div class="card-body">
        ...
        <div class="card-header text-right">
            <a href="{{ route('ombudsman-faq.create') }}" class="btn-default">Novo</a>
        </div>

        @if($ombudsman_faqs && $ombudsman_faqs->count() > 0)
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    @foreach($ombudsman_faqs as $faq)
                    <tr>
                        <td>{{ $faq->id }}</td>
                        <td>{{ Str::limit($faq->question, 71, '...') }}</td>
                        <td>{{ Str::limit($faq->answer, 71, '...') }}</td>
                        <td class="actions">
                            <a href="{{ route('ombudsman-faq.edit', $faq->slug) }}" class="link edit"><i class="fas fa-edit"></i></a>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form id="delete-form-{{ $faq->id }}" action="{{ route('ombudsman-faq.destroy', $faq->slug) }}" method="post" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
