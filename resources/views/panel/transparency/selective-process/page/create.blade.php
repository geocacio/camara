...
<div class="card">
    <div class="card-body">
        <form action="{{ route('page-selective-process.store') }}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" name="main_title" class="form-control main_title" autocomplete="off" value="{{ old('main_title') }}">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="form-group">
